...
{    
    ...
    function showResult(feedback) 
    {
        if (feedback.every((val) => val === "C")) 
        {
            ...
            const $resultDiv = $('<div class="result-message">Congratulations! You guessed the word correctly.</div>');
        ...
        {
            $endfailsound[0].play();
            const $resultDiv = $('<div class="result-message">Sorry, you ran out of chances. The correct word was ' + secretWord + ".</div>");
            $resultDiv.hide().appendTo(".container").fadeIn(1000);
        }
    ...
    function renderHistory() 
    {
        ...
        guessedWords.forEach((word, index) => 
        {
            ...
            const wordClass = feedback.every((val) => val === "C") ? "correct-word" : "incorrect-word";
